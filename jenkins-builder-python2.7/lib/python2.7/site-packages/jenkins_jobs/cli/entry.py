...
def main():
    #argv = sys.argv[1:]
    argv = ['--conf', '/home/dkhodakivsky/Documents/github/ITEA/jenkins-builder-python2.7/jenkins-builder.ini', 'test', '/home/dkhodakivsky/Documents/github/ITEA/jenkins-builder-python2.7/jenkins-builder-wdbs-deploy.yaml']
